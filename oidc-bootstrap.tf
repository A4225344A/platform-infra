  ...
  assume_role_policy = jsonencode({
    ...
    Statement = [{
      ...
      Condition = {
        ...
        StringLike   = { "token.actions.githubusercontent.com:sub" = "repo:<你的帳號>/platform-infra:pull_request*" }
      }
    }]
  })
}
...
resource "aws_iam_role" "gha_apply" {
  ...
  assume_role_policy = jsonencode({
    ...
    Statement = [{
      ...
      Condition = {
        StringEquals = { "token.actions.githubusercontent.com:aud" = "sts.amazonaws.com" }
        StringLike   = { "token.actions.githubusercontent.com:sub" = "repo:<你的帳號>/platform-infra:ref:refs/heads/main" }
      }
    }]
  })
}
