...
echo "PASS: AWS/RDS layer is available, private, encrypted, and backed up."
echo "Run Kubernetes runtime validation separately on the EC2 control node from platform-gitops."
